...
| 1.3 | 7.–9. stunda, Vjeta teorēmas piemērs ${\displaystyle \left\{\begin{array}{l} x + y = 8 \\ xy = -20 \end{array}\right.}$ | ${\displaystyle \left\{\begin{array}{l} m_{1} \cdot m_{2} = -20 \\ m_{1} + m_{2} = -8 \end{array}\right.}$; saknes $m_1 = -10$, $m_2 = 2$; Atbilde. $(-10;\,2)$ un $(2;\,-10)$ | ${\displaystyle \left\{\begin{array}{l} m_{1} \cdot m_{2} = -20 \\ m_{1} + m_{2} = 8 \end{array}\right.}$; saknes $m_1 = 10$, $m_2 = -2$; Atbilde. $(10;\,-2)$ un $(-2;\,10)$ | Vienādojumam $m^2 - 8m - 20 = 0$ ir $p = -8$, tātad $m_1 + m_2 = -p = 8$ (saskan ar sistēmas nosacījumu $x + y = 8$). Dokumentā dotā atbilde neapmierina sistēmu: $-10 + 2 = -8 \neq 8$. |
