...
Ieteicams arī papildināt tekstu ar norādēm uz formatīvās vērtēšanas darbiem un eksāmenu uzdevumu apkopojumu (3.3) un veikt pilnu redakcionālo korektūru (4. sadaļa).
