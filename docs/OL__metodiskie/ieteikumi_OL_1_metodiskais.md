...
permalink: /OL__metodiskie/ieteikumi_OL_1_metodiskais/
---
...
| 1.4 | 2. stunda, 2. paņēmiens „Ar sakņu formulu", piemērs $x^{2}-16=0$ | $D = 0^{2} - 4 \cdot 1 \cdot 16 = 64$ | $D = 0^{2} - 4 \cdot 1 \cdot (-16) = 64$ | Rezultāts 64 ir pareizs, bet pierakstītā izteiksme, kā uzrakstīta, ir vienāda ar $-64$; koeficients ir $c=-16$. |
...
| 1.7 | 4. stunda, turpat, izvērstais pieraksts | $y^{2} - 8y + 16 = y^{2} - 2 \cdot 4 \cdot y + 4^{2} = y^{2} - 8y + 16.$ | $y^{2} - 8y + 16 = y^{2} - 2 \cdot 4 \cdot y + 4^{2} = (y - 4)^{2}.$ | Pārveidojumu ķēde noslēdzas „aplī" (atgriežas pie sākuma izteiksmes), nevis pie rezultāta $(y-4)^2$. |
